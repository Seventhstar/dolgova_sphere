...
ActiveRecord::Schema.define(version: 2021_06_03_165346) do
  ...
  create_table "add_infos", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_add_infos_on_user_id"
  end
  ...
  create_table "course_staffs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["course_id"], name: "index_course_staffs_on_course_id"
    t.index ["user_id"], name: "index_course_staffs_on_user_id"
  end
